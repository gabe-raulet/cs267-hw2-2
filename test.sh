...
#srun -N 1 --ntasks-per-node=1 $BUILD_DIR/mpi -s 1 -n 5000 -o $BUILD_DIR/mpi.n5000.out
#python $CORRECTNESS_DIR/correctness-check.py $BUILD_DIR/mpi.n5000.out $CORRECTNESS_DIR/verf.n5000.out
#rm $BUILD_DIR/mpi.n5000.out
#
#srun -N 1 --ntasks-per-node=4 $BUILD_DIR/mpi -s 1 -n 5000 -o $BUILD_DIR/mpi.n5000.out
#python $CORRECTNESS_DIR/correctness-check.py $BUILD_DIR/mpi.n5000.out $CORRECTNESS_DIR/verf.n5000.out
#rm $BUILD_DIR/mpi.n5000.out
#
#srun -N 1 --ntasks-per-node=16 $BUILD_DIR/mpi -s 1 -n 5000 -o $BUILD_DIR/mpi.n5000.out
#python $CORRECTNESS_DIR/correctness-check.py $BUILD_DIR/mpi.n5000.out $CORRECTNESS_DIR/verf.n5000.out
#rm $BUILD_DIR/mpi.n5000.out
